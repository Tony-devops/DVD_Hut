...
function stockCount(){
  let stockAmount=document.getElementById("low-stock").value
console.log(typeof{stockAmount}, stockAmount)
  let stockAmountnum=parseInt(stockAmount)
  console.log(stockAmountnum);  
  if (stockAmountnum<=10){
    let holder=document.getElementById("sign-display")
    holder.textContent="Low Stock"
  }    
  }
